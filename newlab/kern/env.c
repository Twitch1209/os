...
env_setup_vm(struct Env *e)
{
	...
	//that the env's page dir is identical to that of kernal
	//means the same va point to the same pa
	memcpy(e->env_pgdir, kern_pgdir, PGSIZE); // use kern_pgdir as template 
    p->pp_ref++;
	//it seam to me that different envs may have different 
	//va->pa mapping, although the same mapping can simplify many operations
