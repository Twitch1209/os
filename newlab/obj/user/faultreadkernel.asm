	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 31 1d 80 00 	movsbl 0x801d31(%eax),%eax
  8001f3:	50                   	push   %eax
...
00800240 <vprintfmt>:
{
  ...
  80028c:	ff 24 85 80 1e 80 00 	jmp    *0x801e80(,%eax,4)
  ...
  800358:	8b 14 85 e0 1f 80 00 	mov    0x801fe0(,%eax,4),%edx
  80035f:	85 d2                	test   %edx,%edx
  800361:	74 18                	je     80037b <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800363:	52                   	push   %edx
  800364:	68 11 21 80 00       	push   $0x802111
  800369:	53                   	push   %ebx
  80036a:	56                   	push   %esi
  ...
  80037b:	50                   	push   %eax
  80037c:	68 49 1d 80 00       	push   $0x801d49
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  8003a3:	b8 42 1d 80 00       	mov    $0x801d42,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad7:	68 3f 20 80 00       	push   $0x80203f
  800adc:	6a 23                	push   $0x23
  800ade:	68 5c 20 80 00       	push   $0x80205c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b58:	68 3f 20 80 00       	push   $0x80203f
  800b5d:	6a 23                	push   $0x23
  800b5f:	68 5c 20 80 00       	push   $0x80205c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b9a:	68 3f 20 80 00       	push   $0x80203f
  800b9f:	6a 23                	push   $0x23
  800ba1:	68 5c 20 80 00       	push   $0x80205c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bdc:	68 3f 20 80 00       	push   $0x80203f
  800be1:	6a 23                	push   $0x23
  800be3:	68 5c 20 80 00       	push   $0x80205c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c1e:	68 3f 20 80 00       	push   $0x80203f
  800c23:	6a 23                	push   $0x23
  800c25:	68 5c 20 80 00       	push   $0x80205c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c60:	68 3f 20 80 00       	push   $0x80203f
  800c65:	6a 23                	push   $0x23
  800c67:	68 5c 20 80 00       	push   $0x80205c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca2:	68 3f 20 80 00       	push   $0x80203f
  800ca7:	6a 23                	push   $0x23
  800ca9:	68 5c 20 80 00       	push   $0x80205c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d06:	68 3f 20 80 00       	push   $0x80203f
  800d0b:	6a 23                	push   $0x23
  800d0d:	68 5c 20 80 00       	push   $0x80205c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dec:	ba e8 20 80 00       	mov    $0x8020e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800e0e:	51                   	push   %ecx
  800e0f:	50                   	push   %eax
  800e10:	68 6c 20 80 00       	push   $0x80206c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801068:	53                   	push   %ebx
  801069:	50                   	push   %eax
  80106a:	68 ad 20 80 00       	push   $0x8020ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801131:	53                   	push   %ebx
  801132:	50                   	push   %eax
  801133:	68 c9 20 80 00       	push   $0x8020c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011d9:	53                   	push   %ebx
  8011da:	50                   	push   %eax
  8011db:	68 8c 20 80 00       	push   $0x80208c
...
008013e1 <devfile_read>:
{
  ...
  801436:	c3                   	ret    
	assert(r <= n);
  801437:	68 f8 20 80 00       	push   $0x8020f8
  80143c:	68 ff 20 80 00       	push   $0x8020ff
  801441:	6a 7c                	push   $0x7c
  801443:	68 14 21 80 00       	push   $0x802114
  801448:	e8 85 05 00 00       	call   8019d2 <_panic>
	assert(r <= PGSIZE);
  80144d:	68 1f 21 80 00       	push   $0x80211f
  801452:	68 ff 20 80 00       	push   $0x8020ff
  801457:	6a 7d                	push   $0x7d
  801459:	68 14 21 80 00       	push   $0x802114
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801520:	68 2b 21 80 00       	push   $0x80212b
  801525:	53                   	push   %ebx
...
00801580 <_pipeisclosed>:
{
  ...
  8015c3:	50                   	push   %eax
  8015c4:	53                   	push   %ebx
  8015c5:	68 32 21 80 00       	push   $0x802132
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801865:	68 4a 21 80 00       	push   $0x80214a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019ee:	56                   	push   %esi
  8019ef:	50                   	push   %eax
  8019f0:	68 58 21 80 00       	push   $0x802158
  ...
  801a01:	e8 ec e6 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801a06:	c7 04 24 43 21 80 00 	movl   $0x802143,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a1e:	68 7c 21 80 00       	push   $0x80217c
  801a23:	6a 1a                	push   $0x1a
  801a25:	68 95 21 80 00       	push   $0x802195
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a35:	68 9f 21 80 00       	push   $0x80219f
  801a3a:	6a 2a                	push   $0x2a
  801a3c:	68 95 21 80 00       	push   $0x802195
