...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 00 	movl   $0x801d00,0x803000
  800040:	1d 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800117:	68 0f 1d 80 00       	push   $0x801d0f
  80011c:	6a 23                	push   $0x23
  80011e:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	68 0f 1d 80 00       	push   $0x801d0f
  80019d:	6a 23                	push   $0x23
  80019f:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001da:	68 0f 1d 80 00       	push   $0x801d0f
  8001df:	6a 23                	push   $0x23
  8001e1:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021c:	68 0f 1d 80 00       	push   $0x801d0f
  800221:	6a 23                	push   $0x23
  800223:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025e:	68 0f 1d 80 00       	push   $0x801d0f
  800263:	6a 23                	push   $0x23
  800265:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a0:	68 0f 1d 80 00       	push   $0x801d0f
  8002a5:	6a 23                	push   $0x23
  8002a7:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e2:	68 0f 1d 80 00       	push   $0x801d0f
  8002e7:	6a 23                	push   $0x23
  8002e9:	68 2c 1d 80 00       	push   $0x801d2c
...
sys_ipc_recv(void *dstva)
{
  ...
  800346:	68 0f 1d 80 00       	push   $0x801d0f
  80034b:	6a 23                	push   $0x23
  80034d:	68 2c 1d 80 00       	push   $0x801d2c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba b8 1d 80 00       	mov    $0x801db8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80044e:	51                   	push   %ecx
  80044f:	50                   	push   %eax
  800450:	68 3c 1d 80 00       	push   $0x801d3c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006a8:	53                   	push   %ebx
  8006a9:	50                   	push   %eax
  8006aa:	68 7d 1d 80 00       	push   $0x801d7d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800771:	53                   	push   %ebx
  800772:	50                   	push   %eax
  800773:	68 99 1d 80 00       	push   $0x801d99
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800819:	53                   	push   %ebx
  80081a:	50                   	push   %eax
  80081b:	68 5c 1d 80 00       	push   $0x801d5c
...
00800a21 <devfile_read>:
{
  ...
  800a76:	c3                   	ret    
	assert(r <= n);
  800a77:	68 c8 1d 80 00       	push   $0x801dc8
  800a7c:	68 cf 1d 80 00       	push   $0x801dcf
  800a81:	6a 7c                	push   $0x7c
  800a83:	68 e4 1d 80 00       	push   $0x801de4
  800a88:	e8 85 05 00 00       	call   801012 <_panic>
	assert(r <= PGSIZE);
  800a8d:	68 ef 1d 80 00       	push   $0x801def
  800a92:	68 cf 1d 80 00       	push   $0x801dcf
  800a97:	6a 7d                	push   $0x7d
  800a99:	68 e4 1d 80 00       	push   $0x801de4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b60:	68 fb 1d 80 00       	push   $0x801dfb
  800b65:	53                   	push   %ebx
...
00800bc0 <_pipeisclosed>:
{
  ...
  800c03:	50                   	push   %eax
  800c04:	53                   	push   %ebx
  800c05:	68 02 1e 80 00       	push   $0x801e02
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ea5:	68 1a 1e 80 00       	push   $0x801e1a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80102e:	56                   	push   %esi
  80102f:	50                   	push   %eax
  801030:	68 28 1e 80 00       	push   $0x801e28
  ...
  801041:	e8 56 00 00 00       	call   80109c <vcprintf>
	cprintf("\n");
  801046:	c7 04 24 13 1e 80 00 	movl   $0x801e13,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801196:	0f be 80 4b 1e 80 00 	movsbl 0x801e4b(%eax),%eax
  80119d:	50                   	push   %eax
...
008011ea <vprintfmt>:
{
  ...
  80130d:	52                   	push   %edx
  80130e:	68 e1 1d 80 00       	push   $0x801de1
  801313:	53                   	push   %ebx
  801314:	56                   	push   %esi
  ...
  801325:	50                   	push   %eax
  801326:	68 63 1e 80 00       	push   $0x801e63
  80132b:	53                   	push   %ebx
  80132c:	56                   	push   %esi
  ...
  80134d:	b8 5c 1e 80 00       	mov    $0x801e5c,%eax
